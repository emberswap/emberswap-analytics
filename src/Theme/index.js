...
const theme = (darkMode, color) => ({
  ...
  emberswapred: darkMode ? '#970d0d' : 'black',
  ...
  hoverontext: darkMode ? '#7a7979' : '#7a7777',
  ...
  bg6: darkMode ? '#1b1f26' : '#dddedf',
  bg7: darkMode
    ? 'linear-gradient(193.68deg, #1b1c22 0.68%, #000000 100.48%)'
    : 'linear-gradient(193.68deg, #dddedf 0.68%, #fff 100.48%)',
  bg8: darkMode ? '#1b1f26b3' : '#dddedfb3',

  bg9: darkMode ? 'rgb(25 27 31 / 71%)' : 'rgb(76 74 72 / 15%)',
  // header
  hamburger: darkMode ? '#dddedfb3' : '#1b1f26b3',
  headerbg: darkMode ? '#1b1f26' : '#eff2f5',
  buttonbg: darkMode ? '#6a400c' : '#bf6a00bd',
  //specialty colors
  modalBG: darkMode ? 'rgba(0,0,0,0.85)' : 'rgba(0,0,0,0.6)',
  advancedBG: darkMode ? 'rgba(0,0,0,0.1)' : 'rgba(255,255,255,0.4)',
  onlyLight: darkMode ? '#22242a' : 'transparent',
  divider: darkMode ? 'rgba(43, 43, 43, 0.435)' : 'rgba(43, 43, 43, 0.035)',
  chartcolor: darkMode ? 'rgba(255, 209, 101, 0.5)' : '',

  //primary colors
  primary1: darkMode ? '#ec7024' : '#970d0d',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#970d0d',

  // secondary colors
  secondary1: darkMode ? '#ec7024' : '#970d0d',
