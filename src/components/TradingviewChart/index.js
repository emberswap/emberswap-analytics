      ...
      var series =
        type === CHART_TYPES.BAR
          ? chart.addHistogramSeries({
              color: darkMode ? 'rgb(150, 83, 0)' : '#d96707',
              priceFormat: {
                type: 'volume',
              },
              scaleMargins: {
              ...
              lineColor: darkMode ? '#fff' : '#970d0d',
              lineWidth: 3,
            })
          : chart.addAreaSeries({
              topColor: darkMode ? `#970d0d` : 'rgba(255, 209, 101, 0.5)',
              bottomColor: darkMode ? 'rgba(255, 209, 101, 0.5)' : '#970d0d',
              lineColor: 'rgba(255, 209, 101, 0.5)',
              lineWidth: 1,
            })
