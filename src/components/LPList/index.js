    ...
    return (
      <DashGrid style={{ height: '48px' }} disbaleLinks={disbaleLinks} focus={true}>
        ...
        <DataText area="name" fontWeight="500" justifyContent="flex-start">
          {lp.user.id !== '0x8ecb32c33ab3f7ee3d6ce9d4020bc53fecb36be9' &&
            lp.user.id !== '0xc6752c2f631416eb6a820e18c159ddf39269c5e9' && (
              <CustomLink
          ...
          {lp.user.id === '0x8ecb32c33ab3f7ee3d6ce9d4020bc53fecb36be9' &&
            lp.user.id !== '0xc6752c2f631416eb6a820e18c159ddf39269c5e9' && (
              <CustomLink
                ...
                to={'/account/' + lp.user.id}
              >
                {below800 ? 'DistributorV2' : 'EmberDistributorV2'}
              </CustomLink>
            )}
          {lp.user.id !== '0x8ecb32c33ab3f7ee3d6ce9d4020bc53fecb36be9' &&
            lp.user.id === '0xc6752c2f631416eb6a820e18c159ddf39269c5e9' && (
              <CustomLink
                ...
                to={'/account/' + lp.user.id}
              >
                {below800 ? 'Treasury' : 'Governed Treasury'}
              </CustomLink>
            )}
        </DataText>
