        ...
        {!below780 && (
          <>
            <DataText area="amountOther">
              ...
              <FormattedName text={item.token1Symbol} maxCharacters={8} margin={true} />
            </DataText>
            <DataText area="amountToken">
              {formattedNum(item.token0Amount) + ' '}{' '}
              <FormattedName text={item.token0Symbol} maxCharacters={8} margin={true} />
            </DataText>
          </>
        )}
        {!below1080 && (
          <DataText area="account">
            <Link color={color} external href={'https://smartscan.cash/address/' + item.account}>
