...
export default function UniPrice() {
  const daiPair = usePairData('0xfae17176acc70d8b3d51ee6b1978889a0fb6bbd4')
  const usdcPair = usePairData('0x35df4a3a96649b6bb9188d2a269ec75ceb5f5132')
  const usdtPair = usePairData('0x8e6c07bf179a50d266bd9980703da3ffdf36f7b5')
  ...
  return (
    <PriceCard>
      <AutoColumn gap="10px">
        <RowFixed>
          <TYPE.main>flexUSD: {formattedNum(daiPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
            {daiPair && totalLiquidity ? formatPercent(daiPair.trackedReserveUSD / totalLiquidity) : '-'}
          </TYPE.light>
        </RowFixed>
        <RowFixed>
          <TYPE.main>lawUSD: {formattedNum(usdcPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
            {usdcPair && totalLiquidity ? formatPercent(usdcPair.trackedReserveUSD / totalLiquidity) : '-'}
          </TYPE.light>
        </RowFixed>
        <RowFixed>
          <TYPE.main>sBUSD: {formattedNum(usdtPerEth, true)}</TYPE.main>
          <TYPE.light style={{ marginLeft: '10px' }}>
